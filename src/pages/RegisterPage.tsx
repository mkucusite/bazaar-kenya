...
import { sanitizeRedirect, storePostAuthRedirect } from "@/lib/auth-redirect";
      ...
      <div className="flex items-center justify-center py-12 md:py-16 px-4">
        <div className="w-full max-w-sm">
          ...
          <div className="bg-card rounded-2xl border border-border/60 shadow-sm p-6">
            ...
            <Button variant="outline" className="w-full h-10" onClick={() => { storePostAuthRedirect(sanitizeRedirect(new URLSearchParams(window.location.search).get("redirect"))); void signInWithGoogle(); }}>
