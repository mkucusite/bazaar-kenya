...
const ChatsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <SEOHead title="Messages — Chat with Buyers & Sellers" description="Chat securely with buyers and sellers on KenyaAdvert." canonical="https://www.kenyaadverts.com/chats" />
      <Navbar />
