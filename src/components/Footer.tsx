        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <img src={logo} alt="KenyaAdvert" className="h-10 md:h-12 w-auto" loading="lazy" />
            </div>
            <p className="text-sm text-slate-400 mb-4">Buy. Sell. Advertise. Kenya's trusted classifieds platform.</p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              <li>
                <Link to="/post-ad" className="hover:text-white transition-colors">
                  Post an Ad
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/search?category=Business+Profiles" className="hover:text-white transition-colors">
                  Business Profiles
                </Link>
              </li>
            </ul>
